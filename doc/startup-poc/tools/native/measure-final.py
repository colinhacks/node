...
def reference_plan(startup, artifacts, final_label, references):
    suffix = '.exe' if os.name == 'nt' else ''
    workloads = []
    ...
    return dict(startup, rounds=200, warmups=10, seed=20260916,
                artifacts={'baseline': artifacts['baseline'], final_label: artifacts[final_label],
                           'release': str(references / ('release-node' + suffix)),
